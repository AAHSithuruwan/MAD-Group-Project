                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow:[
                            BoxShadow(
                              color: Color.fromRGBO(0, 0, 0, 0.25), // Shadow color with opacity
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text("Welcome to",textAlign: TextAlign.center,style: TextStyle(fontSize: 20, fontFamily: "InknutAntiqua", color: Colors.white),),
                            ),
                            Padding(
                              padding: const EdgeInsets.fromLTRB(15, 5, 15, 15),
                              child: Text("My Shopping List",textAlign: TextAlign.center,style: TextStyle(fontSize: 36, fontFamily: "InknutAntiqua",color: Colors.white),),
                            )
                          ],
                          ...
                          child: Container(
                            ...
                            child: MaterialButton(
                                onPressed: (){
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => const SignInSelection()),
                                  );
                                },
                              ...
                              color: Colors.white,
                              child: Text("Sign In",style: TextStyle(fontSize: 22, fontFamily: "Pacifico"),),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: MaterialButton(
                              ...
                              child: Text("Register",style: TextStyle(fontSize: 22, fontFamily: "Pacifico",color: Colors.white),),
                            ),
                          ),
                        )
                      ],
